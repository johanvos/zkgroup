...
*/
  ...
  public static native int serverSecretParamsIssuePniCredentialDeterministicJNI(byte[] self, byte[] randomness, byte[] profileKeyCredentialRequest, byte[] aci, byte[] pni, byte[] profileKeyCommitment, byte[] output);
  ...
  public static native int serverSecretParamsVerifyPniCredentialPresentationJNI(byte[] self, byte[] groupPublicParams, byte[] pniCredentialPresentation);
  ...
  public static native int pniCredentialRequestContextGetRequestJNI(byte[] self, byte[] output);
  public static native int pniCredentialRequestContextCheckValidContentsJNI(byte[] self);
  ...
  public static native int pniCredentialResponseCheckValidContentsJNI(byte[] self);
  public static native int profileKeyCredentialCheckValidContentsJNI(byte[] self);
  public static native int pniCredentialCheckValidContentsJNI(byte[] self);
  ...
  public static native int pniCredentialPresentationGetAciCiphertextJNI(byte[] self, byte[] output);
  public static native int pniCredentialPresentationGetPniCiphertextJNI(byte[] self, byte[] output);
  public static native int pniCredentialPresentationGetProfileKeyCiphertextJNI(byte[] self, byte[] output);
  public static native int pniCredentialPresentationCheckValidContentsJNI(byte[] self);
